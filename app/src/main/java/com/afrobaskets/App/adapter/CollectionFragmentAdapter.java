...
import com.afrobaskets.App.activity.CollectionDetailActivity;
...
public class CollectionFragmentAdapter extends RecyclerView.Adapter<CollectionFragmentAdapter.MyViewHolder> {
    ...
    public CollectionFragmentAdapter(Context context, ArrayList<OrderCollectionBean> orderCollectionBeen,RecyclerView recyclerView) {
