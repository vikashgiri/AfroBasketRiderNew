...
import com.afrobaskets.App.adapter.CollectionHistoryAdapter;
...
ImageView toolbar_back=(ImageView)findViewById(R.id.toolbar_back);
    ...
    void getData(final Context context)
    {
        ...
        try {
            ...
            sendJson.put("order_status","past_order");
            sendJson.put("user_id", SavePref.getPref(CollectionHistoryActivity.this,SavePref.User_id));
        }catch (Exception e)
        {
            e.printStackTrace();
        }
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            while (orderlistkeys.hasNext()) {
                                ...
                                while (userListkeys.hasNext()) {
                                    ...
                                    if(shippingorderJObject.getString("user_id").equalsIgnoreCase(userJObject                                                     .getString("id"))) {
                                        ...
                                        UserDetailBeans.setCity_id("sxsxs");
                         ...
                         pDialog.dismiss();   set(orderCollectionBeanArrayList); // This will make a callback to activity.
                        }
    ...
    void set(ArrayList<OrderCollectionBean> cartListBeanArrayList) {
        CollectionHistoryAdapter fAdapter = new CollectionHistoryAdapter(this, cartListBeanArrayList,recyclerView);
